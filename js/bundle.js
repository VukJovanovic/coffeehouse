...
exports.showProducts = exports.contentContainerHide = exports.contentContainerShow = exports.closeMenu = exports.showMenu = void 0;
...
var contentContainerShow = function contentContainerShow() {
  ...
  var checkHeader = _underscore.default.throttle(function () {
    ...
    var scrollPosition = Math.round(contentContainer.scrollTop); // If we scrolled we add class to our navigation bar
...
var contentContainerHide = function contentContainerHide() {
  contentContainer.innerHTML = '';
  TweenMax.to(contentContainer, 1, {
    width: '0rem',
    padding: '0rem'
  });
};
...
var showProducts = function showProducts() {
  var productPageHeading = document.querySelector('.productHeading');
  var productCard = document.querySelectorAll('.productCard');
  var productBtn = document.querySelectorAll('.showMore__button');
  TweenMax.to(productPageHeading, 0.3, {
    opacity: 1,
    delay: 0.8
  });
  var delay = 0.9;
...
},{"underscore":"../node_modules/underscore/underscore.js"}],"helperFunctions.js":[function(require,module,exports) {
"use strict";
...
exports.contentContainerFunction = exports.homePageFunction = void 0;
...
var homePageFunction = function homePageFunction(activeEl) {
  var imageObject = {
...
exports.homePageFunction = homePageFunction;

var contentContainerFunction = function contentContainerFunction(activeEl) {
  var imageObject = {
    imgs: [logoImage, shoppingCartImage],
...
exports.contentContainerFunction = contentContainerFunction;
...
exports.checkIfActive = checkIfActive;
},{}],"uiFunctions.js":[function(require,module,exports) {
"use strict";
...
var _uiFunctions = require("./uiFunctions");

// import { checkHeader } from './scrollAnimation';
var homepageImage1 = document.getElementById('homepageImage-1');
var homepageImage2 = document.getElementById('homepageImage-2');
var homepageImage3 = document.getElementById('homepageImage-3'); // displaying different images for mobile phones
...
homeBtn.addEventListener('click', function (e) {
  ...
  if (active === homepage) {
    ...
    if (active === contentContainer) {
      (0, _pageFunctions.homePageFunction)(active);
      (0, _animations.closeMenu)();
      (0, _animations.contentContainerHide)();
    }
  }
});
/**
...
productBtn.addEventListener('click', function (e) {
  ...
  if (active === contentContainer) {
    ...
    (0, _pageFunctions.contentContainerFunction)(active);
    (0, _animations.closeMenu)();
    (0, _animations.contentContainerShow)();
    (0, _uiFunctions.displayProducts)(contentContainer);
  }
...
},{"./animations":"animations.js","./pageFunctions":"pageFunctions.js","./checkActiveFunction":"checkActiveFunction.js","./uiFunctions":"uiFunctions.js"}],"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
